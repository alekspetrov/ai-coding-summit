...
| [TASK-03](./tasks/TASK-03-pure-logic.md) | Pure logic + tests | ✅ Merged (Pilot #2, 9074176) · unified on schema in TASK-09 (193474e) |
...
| [TASK-09](./tasks/TASK-09-unify-logic-types-on-schema.md) | Unify logic types on Zod schema | ✅ Complete (193474e) — `lib/types.ts` deleted; `searchEvent` takes lowercase `Event`; fixtures schema-valid |
